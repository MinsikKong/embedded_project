...
//http://digitalhacksblog.blogspot.kr/2012/05/android-example-bluetooth-simple-spp.html
...
public class BluetoothSender extends Activity {
	...
	private static String address = "00:15:83:50:57:CE";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		orderArray = (ArrayList<OrderItemBean>) intent
				.getSerializableExtra("orderArray");

		Log.d(ACTIVITY_SERVICE, totalPay + "");
		Log.d(ACTIVITY_SERVICE, orderArray.toString());

		out = (TextView) findViewById(R.id.btprompt);
	...
	private String ordersToString() {
		...
		for (int i = 0; i < orderArray.size(); i++) {
			orders = orders.concat("," + orderArray.get(i).itemName + ","
					+ orderArray.get(i).totalPrice);
		}
		return orders;
	}
